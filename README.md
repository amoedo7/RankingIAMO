...
| **IAMO870** | `research_incomplete` | 45% | A working MVP of 'E-commerce product-feed cleanup' with a narrow promise, demo/deliverable and simple purchase | **€0.00** |
| **IAMO869** | `research_incomplete` | 40% | A working MVP of 'Paid update feed for a tool, dataset or directory' with a narrow promise, demo/deliverable a | **€0.00** |

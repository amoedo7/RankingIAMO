...
| **IAMO733** | `research_incomplete` | 40% | A working MVP of 'iPhone subscription utility' with a narrow promise, demo/deliverable and simple purchase pat | **€0.00** |
| **IAMO732** | `research_incomplete` | 35% | A working MVP of 'SEO technical audit' with a narrow promise, demo/deliverable and simple purchase path. First | **€0.00** |
| **IAMO731** | `research_incomplete` | 50% | A working MVP of 'Paid API wrapper around a difficult public workflow' with a narrow promise, demo/deliverable | **€0.00** |
| **IAMO730** | `research_incomplete` | 45% | A working MVP of 'E-commerce product-feed cleanup' with a narrow promise, demo/deliverable and simple purchase | **€0.00** |

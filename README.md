...
![IAMOs](https://img.shields.io/badge/IAMOs-47-7aa2ff?style=for-the-badge) ![Beneficio%20verificado](https://img.shields.io/badge/Beneficio%20verificado-EUR%200.00-49e59a?style=for-the-badge) ![Cobros](https://img.shields.io/badge/Cobros-0-ffd35a?style=for-the-badge)
...
|---|---|---:|---|---:|
| **IAMO47** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO46** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO45** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO44** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO43** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO42** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO41** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO40** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO39** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO38** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |

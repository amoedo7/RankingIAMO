...
| **IAMO295** | `research_incomplete` | 50% | A working MVP of 'On-chain public-data dashboard' with a narrow promise, demo/deliverable and simple purchase  | **€0.00** |
| **IAMO294** | `research_incomplete` | 45% | A working MVP of 'Hosting/domain/tool affiliate tutorials' with a narrow promise, demo/deliverable and simple  | **€0.00** |
| **IAMO293** | `research_incomplete` | 40% | A working MVP of 'iPhone subscription utility' with a narrow promise, demo/deliverable and simple purchase pat | **€0.00** |
| **IAMO292** | `research_incomplete` | 35% | A working MVP of 'SEO technical audit' with a narrow promise, demo/deliverable and simple purchase path. First | **€0.00** |
| **IAMO291** | `research_incomplete` | 50% | A working MVP of 'Paid API wrapper around a difficult public workflow' with a narrow promise, demo/deliverable | **€0.00** |
| **IAMO290** | `research_incomplete` | 45% | A working MVP of 'E-commerce product-feed cleanup' with a narrow promise, demo/deliverable and simple purchase | **€0.00** |

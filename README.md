...
![IAMOs](https://img.shields.io/badge/IAMOs-71-7aa2ff?style=for-the-badge) ![Beneficio%20verificado](https://img.shields.io/badge/Beneficio%20verificado-EUR%200.00-49e59a?style=for-the-badge) ![Cobros](https://img.shields.io/badge/Cobros-0-ffd35a?style=for-the-badge)
...
|---|---|---:|---|---:|
| **IAMO71** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO70** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO69** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO68** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO67** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO66** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO65** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO64** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO63** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO62** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO61** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
| **IAMO60** | `invalid_agent_output` | 0% | Esperando estrategia | **€0.00** |
